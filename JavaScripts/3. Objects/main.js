...
const array3 = ['John', 'Simon', 'Sandra'];

const [user1, user2, ...restOfUsers] = array3
...
const sortedNumbers = array2.sort(function (a, b) {
  console.log(a, b);
  return a - b; // sort numbers in ascending order
});
console.log(sortedNumbers);

// REVERSE => reverse the elements of an array in place and return the array.
const reversedNumbers = array.reverse();
